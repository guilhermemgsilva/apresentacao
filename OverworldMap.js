        ...
        cutsceneSpaces: {
            [utils.asGridCoord(32, 20)]: [
                {
                    events: [
                        ...
                        { type: "textMessage", text: "Bom dia Capitão, meu nome é Bancário e hoje é o meu primeiro dia.", speaker: "Bancário" },
            ...
            [utils.asGridCoord(52, 23)]: [{
                events: [
                    ...
                    { type: "textMessage", text: "Você vai lá no capitão, avisa sobre essa demanda.", speaker: "Guarda Tião" },
        ...
        cutsceneSpaces: {
            [utils.asGridCoord(5, 12)]: [{
                events: [
                    ...
                    { type: "textMessage", text: "Precisamos de um documento detalhado nos mínimos detalhes para começarmos a agir.", speaker: "Capitão" },
                    ...
                    { type: "textMessage", text: "Criar um modelo de defesa, então após isso vamos contra atacar de uma vez, isso será a validação da estratégia já na prática.", speaker: "Capitão" },
                    ...
                    { type: "textMessage", text: "Isso gera uma documentação extensa que trorna o contrato de trabalho e o guia rígido para todas as fases.", speaker: "Narrador" },
                ]
            }],
        ...
        cutsceneSpaces: {
            [utils.asGridCoord(5, 12)]: [{
                events: [
                    ...
                    { type: "textMessage", text: "Vá depressa à sala de treinamento, lá você verá uma folha de papel com a filosofia manifesto que os sábios escreveram para esse momento.", speaker: "Capitão" },
                    { type: "textMessage", text: "Medite nessa filosofia.", speaker: "Bancário" },
        ...
        cutsceneSpaces: {
            [utils.asGridCoord(5, 13)]: [{
                events: [
                    ...
                    { type: "textMessage", text: "Indivíduos e interações mais que processos e ferramentas.", speaker: "Narrador" },
                    ...
                    { type: "textMessage", text: "O PI é o evento mais importante. ", speaker: "Narrador" },
